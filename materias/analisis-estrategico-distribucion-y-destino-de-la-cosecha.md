...
Por ello se ha diseñado un modelo de segregación de inventarios en el cual se procesa toda la base de datos de producción y, mediante una fórmula de calibración aplicada en Spark, separa automáticamente el volumen en dos categorías clave:
